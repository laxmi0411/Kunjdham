            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">
                            Have a question or want to book a room? Fill in the form below and we'll get back to you as soon as possible. You can also reach us directly via phone or email.
                        </p>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Your Message" id="contact_message"
                                            name="message" style="height: 130px;" required><?php echo htmlspecialchars($old['message'] ?? ''); ?></textarea>
                        ...
                        <div class="bg-light rounded p-4 mb-4">
                            ...
                            <div class="d-flex align-items-start mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Attala chungi, parikarma marg t.b, hospital lane,<br>Vrindavan, Uttar Pradesh 281121</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start mb-3">
                                <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style="width:40px;height:40px;">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0"><a href="tel:+918797674709" class="text-dark text-decoration-none">+91 87976 74709</a></p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start mb-3">
                                <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style="width:40px;height:40px;">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <a href="https://wa.me/918797674709" target="_blank" class="text-success text-decoration-none fw-bold">
                                            Chat on WhatsApp
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0"><a href="mailto:lakshmitk2301@gmail.com" class="text-dark text-decoration-none">lakshmitk2301@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- Google Map -->
